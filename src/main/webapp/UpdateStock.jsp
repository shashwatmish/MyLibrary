		...
		<div class="col-md-6">
			<div class="card">
				<article class="card-body">
					<form id="form" action="/updatestock" method="post" modelAttribute="stock">
						<div class="form-row">
						...
						<small class="text-muted">Please be careful while updating this. This is only meant 
						to update the database when new books are bought by the library.
						</small>
