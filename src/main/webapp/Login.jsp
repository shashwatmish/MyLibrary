...
<body>
 ...
 -->
	...
	<header class="masthead" style="height: 500px;">
		...
		<a href="/student/login" class="btn btn-primary" style="position: absolute;top: 35%;left: 40%;width:300px;height:70px;font-size:22px;"><h3>Student</h3></a>
		<a href="/staff/login" class="btn btn-primary" style="position: absolute;top: 55%;left: 40%;width:300px;height:70px;font-size:22px;"><h3>Staff</h3></a>
		<a href="/manager/login" class="btn btn-primary" style="position: absolute;top: 75%;left: 40%;width:300px;height:70px;font-size:22px;"><h3>Manager</h3></a>
